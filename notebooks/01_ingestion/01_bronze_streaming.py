...
# Configured for production via Key Vault Secret Scope
...
# Bronze data already exists - always skip since we're using batch mode
print(f"Bronze data already exists at {ROOT_PATH}/bronze/orders. Skipping ingestion.")
